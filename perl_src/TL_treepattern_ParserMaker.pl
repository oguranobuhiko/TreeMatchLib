...
# my $start_symbol='PathAndTreePattern';
my $start_symbol='TreePattern';
my @rules_src = ();
...
# add_rule 'PathAndTreePattern', [qw/TreePattern/];
# add_rule 'PathAndTreePattern', [qw/; TreePattern/];
# add_rule 'PathAndTreePattern', [qw/PathPattern ; TreePattern/];
# add_rule 'PathAndTreePattern', [qw/PathPattern ;/];

add_rule 'TreePattern', [qw/NodeTerm012Joint/];

# add_rule 'PathPattern', ['-']; #暫定
# 


# add_rule 'NodeTerm012Joint', [qw/NodeTerm012 JointTerm012/];
# add_rule 'JointTerm012', [qw/JointTerm JointTerm012/];
# add_rule 'JointTerm012', [];
# 
# add_rule 'JointTerm', [qw/> NodeTerm012/];
# add_rule 'JointTerm', [qw/| NodeTerm012/];
# add_rule 'JointTerm', [qw/~ NodeTerm012/];
# # 上6個を、下4個に変えてみた

add_rule 'NodeTerm012Joint', [qw/NodeTerm012 > NodeTerm012Joint/];
add_rule 'NodeTerm012Joint', [qw/NodeTerm012 > ~ NodeTerm012Joint/];
add_rule 'NodeTerm012Joint', [qw/NodeTerm012 | NodeTerm012Joint/];
add_rule 'NodeTerm012Joint', [qw/NodeTerm012/];
...
add_rule 'NodeTerm012', [qw/NodeTerm NodeTerm012/];
add_rule 'NodeTerm012', [qw//];



add_rule 'NodeTerm', [qw/NodeFactor/];
add_rule 'NodeTerm', [qw/NodeFactor */];
add_rule 'NodeTerm', [qw/NodeFactor * ?/];
add_rule 'NodeTerm', [qw/NodeFactor +/];
add_rule 'NodeTerm', [qw/NodeFactor + ?/];
...
add_rule 'NodeFactor', [qw/NodeFactorWithCond/];
add_rule 'NodeFactor', [qw/- NodeFactorWithCond/];
add_rule 'NodeFactor', [qw/NodeBlock/];

    add_rule 'NodeBlock', [qw/t_LABEL ( NodeTerm012Joint )/];
    add_rule 'NodeBlock', [qw/( NodeTerm012Joint )/];
    add_rule 'NodeBlock', [qw/(? - t_LITERAL )/];


    #              add_rule 'NodeFactorWithCond', [qw/t_LITERAL/];  # 暫定


    add_rule 'NodeFactorWithCond', [qw/! NodeFactorWithPostCond/];
    add_rule 'NodeFactorWithCond', [qw/NodeFactorWithPostCond/];
...
my $PG_PARSER_ID = 'TreePatternParser';
...
$PG_OUTPUT_FILE->{perl} = 'output_TreePatParser_p.pm';
$PG_OUTPUT_FILE->{javascript} = '../js_src/TLParser_generated.js';
